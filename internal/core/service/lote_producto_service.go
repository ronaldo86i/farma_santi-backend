...
func (l LoteProductoService) ObtenerListaLotesProductos(ctx context.Context, filtros map[string]string) (*[]domain.LoteProductoInfo, error) {
	return l.loteProductoRepository.ObtenerListaLotesProductos(ctx, filtros)
}
